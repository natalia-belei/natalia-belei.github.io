...
import AnimatedNumbers from './_components/AnimatedNumbers';
import Skills from './_components/Skills';
import Timeline from './_components/Timeline';
import { aboutPageConfig } from '../../../data-config/about';
import ReactMarkdown from 'react-markdown';
import { experienceData } from '../../../data-config/experience';
import { certificationsData } from '../../../data-config/certifications';
import TransitionEffect from '../_shared-components/TransitionEffect';

export const metadata = {
    title: aboutPageConfig.meta.title,
    description: aboutPageConfig.meta.description
}
...
const mapCertificationsToTimelineItems = (certificationsArray) => {
...
const mapExperienceToTimelineItems = (experienceArray) => {
